...
Ngreen.lm <- lm(Ngreen ~ MYCO_ASSO + pgf + mat + map, data = d)
Nsenes.lm <- lm(Nsenes ~ MYCO_ASSO + pgf + mat + map, data = d)
Nroots.lm <- lm(Nroots ~ MYCO_ASSO + pgf + mat + map, data = d)
Pgreen.lm <- lm(Pgreen ~ MYCO_ASSO + pgf + mat + map, data = d)
Psenes.lm <- lm(Psenes ~ MYCO_ASSO + pgf + mat + map, data = d)
Proots.lm <- lm(Proots ~ MYCO_ASSO + pgf + mat + map, data = d)
log.LL.lm <- lm(log.LL ~ MYCO_ASSO + pgf + mat + map, data = d)
root.L.lm <- lm(root.L ~ MYCO_ASSO + pgf + mat + map, data = d)
...
#Run PGLS analyses.----
Ngreen.pg <- pic_pro(y = 'Ngreen', x = c('MYCO_ASSO','pgf','mat','map'), phylogeny = phy, trait.data = d)
Nsenes.pg <- pic_pro(y = 'Nsenes', x = c('MYCO_ASSO','pgf','mat','map'), phylogeny = phy, trait.data = d)
Nroots.pg <- pic_pro(y = 'Nroots', x = c('MYCO_ASSO','pgf','mat','map'), phylogeny = phy, trait.data = d)
Pgreen.pg <- pic_pro(y = 'Pgreen', x = c('MYCO_ASSO','pgf','mat','map'), phylogeny = phy, trait.data = d)
Psenes.pg <- pic_pro(y = 'Psenes', x = c('MYCO_ASSO','pgf','mat','map'), phylogeny = phy, trait.data = d)
Proots.pg <- pic_pro(y = 'Proots', x = c('MYCO_ASSO','pgf','mat','map'), phylogeny = phy, trait.data = d)
log.LL.pg <- pic_pro(y = 'log.LL', x = c('MYCO_ASSO','pgf','mat','map'), phylogeny = phy, trait.data = d)
root.L.pg <- pic_pro(y = 'root.L', x = c('MYCO_ASSO','pgf','mat','map'), phylogeny = phy, trait.data = d)
